...
namespace Marten.Generated.EventStore
{
    ...
    public class AppendEventOperation : Marten.Events.Operations.AppendEventOperationBase
    {
        ...
        public const string SQL = "insert into eventstore.mt_events (data, type, mt_dotnet_type, seq_id, id, stream_id, version, timestamp, tenant_id) values (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public class GeneratedInsertStream : Marten.Events.Operations.InsertStreamBase
    {
        ...
        public const string SQL = "insert into eventstore.mt_streams (id, type, version, tenant_id) values (?, ?, ?, ?)";
    ...
    public class GeneratedStreamStateQueryHandler : Marten.Events.Querying.StreamStateQueryHandler
    {
        ...
        public const string SQL = "select id, version, type, timestamp, created as timestamp, is_archived from eventstore.mt_streams where id = ?";
    ...
    public class GeneratedStreamVersionOperation : Marten.Events.Operations.UpdateStreamVersion
    {
        ...
        public const string SQL = "update eventstore.mt_streams set version = ? where id = ? and version = ?";
